...
private:
	...
	void colorYsInTriangle(int x, int minY, int maxY, const glm::vec2& point1, const glm::vec2& point2, const glm::vec2& point3, const glm::vec3& color, bool shouldFog, glm::vec3 fogColor, float fogDensity, glm::vec4 cameraPosition);
...
public:
	...
	void colorTriangle(const glm::vec2& p1, const glm::vec2& p2, const glm::vec2& p3, const glm::vec3& color, bool shouldFog, glm::vec3 fogColor, float fogDensity, glm::vec4 cameraPosition);
